...
我们推荐下载 VCB-Studio 的压制生产力工具 OKEGui，你可以在[这里](https://github.com/vapoursynth/vapoursynth/releases)下载到已经打包好的版本，解压即用。我们暂时不会介绍 OKEGui 的使用方法，因为它比较复杂，只有熟练掌握压制流程之后才能更好地理解其用法。在 OKEGui\tools 中集成了许多实用的命令行工具，基本能够满足本章教程的大部分需求。
